...
const STRINGS = {
  ca: {
    ...
    'osm.sortLabel': 'Ordenar per',
    'osm.sortNone': 'Sense ordenar',
    'osm.sortLengthAsc': 'Longitud: curt → llarg',
    'osm.sortLengthDesc': 'Longitud: llarg → curt',
    'osm.sortDistAsc': 'Distància al punt: a prop → lluny',
    'osm.sortDistDesc': 'Distància al punt: lluny → a prop',
  ...
  es: {
    ...
    'osm.sortLabel': 'Ordenar por',
    'osm.sortNone': 'Sin ordenar',
    'osm.sortLengthAsc': 'Longitud: corto → largo',
    'osm.sortLengthDesc': 'Longitud: largo → corto',
    'osm.sortDistAsc': 'Distancia al punto: cerca → lejos',
    'osm.sortDistDesc': 'Distancia al punto: lejos → cerca',
